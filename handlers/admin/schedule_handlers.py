...
@router.message(F.text == f"{E.CANCEL} Отмена", F.state.in_(creation_states))
...
cancal_states = [ScheduleCreation, EditSession, TestCreation, TestDeletion, ScheduleDeletion, EditTest]
